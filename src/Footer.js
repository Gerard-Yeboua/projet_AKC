...
function Footer() {
  return (
        ...
        <Container className="container-footer">
            <Row className="row line-content">
                
                <Col className="footer-col">
                    <h4 className="">Gerard@</h4>
                </Col>
                
                <Col className="footer-col">
                    <h4 clasNamesName="">Contactez-nous</h4>
                    <ul className="">
                        <li><a href="">Adresse : Abidjan Cocody-Danga</a></li>
                        <li><a href="">Tel: (+225) 0789297259</a></li>
                        <li><a href="">Email : kragerard2@gmail.com</a></li>
                    </ul>
                </Col>
                ...
                <Col className="footer-col">
                    ...
                    <ul className="">
                        ...
                        <li><a href="contact.html">formulaire d'inscription</a></li>
                    </ul>
                </Col>
                ...
                <hr></hr>
                <p className="copyright">&copy; Copyright Gerard Yeboua 2023</p>
        </Container>
    </div>
  );
}
